                ...
                <a class="nav-link {{ ($title === "POST") ? 'active' : ''  }} " href="/postingan">Post</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                            <li><a class="dropdown-item {{ $title === 'BLOG' ? 'active' : '' }} "
                                    href="/postingan">All post</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            @foreach ($categories as $cateitem)
                                <li><a class="dropdown-item"
                                        href="/categories/{{ $cateitem->slug }}">{{ $cateitem->name }}</a></li>
                            @endforeach
                ...
                <ul class="navbar-nav">
                    @auth
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/dasboards"><i class="bi bi-layout-text-window"></i> My
                                        Dashboard </a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                    ...
                    @else
                        <li class="nav-item d-flex">
                            <a class="nav-link {{ $title === 'LOGIN' ? 'active' : '' }} me-2" aria-current="page"
                                href="/login"><i class="bi bi-box-arrow-in-right me-1"></i>Login</a>
                        </li>
